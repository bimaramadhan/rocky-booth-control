...
export const stockDetailSchema=z.object({stockItemId:uuid,physical:z.number().nonnegative(),note:z.string().trim().max(500).optional()});
export const stockPhotoCategorySchema=z.enum(["freezer","shelf","booth"]);
